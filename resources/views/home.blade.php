                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-4 col-lg-6 col-md-6 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="200">
                            <div class="blog-card style2">
                                <div id="blog-img">
                                    ...
                                    <div class="svgstyle">
                                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="31.075 21.391 138.032 158.809" xmlns="http://www.w3.org/2000/svg"  viewBox="31.075 21.391 138.032 158.809" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-imlofp3r svg [data-color="1"] {fill: #FFFFFF;}</style></defs>
                                        <g>
                                            ...
                                            <path fill="#366a56" d="M69 151.1c-1.4 0-2.7 1.2-2.7 2.6 0 3.8-3.8 8.8-7.4 12.1-3.4 3.1-5.9 4.1-10.5 5.7-4.9 1.6-9.9 2.8-15 3.4-1.5.2-2.5 1.5-2.3 3 .2 1.3 1.3 2.3 2.6 2.3h.3c5.5-.7 10.9-1.9 16.1-3.7 4.7-1.6 8.1-2.9 12.4-6.7 2.1-1.9 9.1-8.7 9.2-16-.1-1.5-1.3-2.7-2.7-2.7z" data-color="1"></path>
                                            <path fill="#366a56" d="M166.7 174.9c-5.1-.6-10.2-1.8-15-3.4-4.6-1.5-7.1-2.6-10.5-5.7-3.7-3.3-7.4-8.3-7.4-12.1 0-1.5-1.2-2.7-2.7-2.6-1.5 0-2.6 1.2-2.6 2.7.1 7.3 7.1 14.1 9.2 16 4.3 3.8 7.7 5.2 12.4 6.7 5.2 1.8 10.6 3 16.1 3.7h.3c1.3 0 2.5-1 2.6-2.3.1-1.5-.9-2.9-2.4-3z" data-color="1"></path>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="400">
                            <div class="blog-card style2">
                                <div id="blog-img">
                                    <div class="svgstyle">
                                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="15 15 170 170" viewBox="15 15 170 170" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-imm6az2x svg [data-color="1"] {fill: #FFFFFF;}
                                        #comp-imm6az2x svg [data-color="2"] {fill: #2F2E2E;}</style></defs>
                                            <g>
